function [x, info] = ASQPv2(Q, c, A, b, x0, W0, max_iter, toll, varargin)
    ...
    [x1_grid, x2_grid] = meshgrid(linspace(-5, 10, 100), linspace(0, 3, 100));
    ...
    fimplicit(@(x1, x2) A(1,1)*x1 + A(1,2)*x2 - b(1), [-5 10 0 3], 'r', 'LineWidth', 1.5);
    fimplicit(@(x1, x2) A(2,1)*x1 + A(2,2)*x2 - b(2), [-5 10 0 3], 'b', 'LineWidth', 1.5);
    fimplicit(@(x1, x2) A(3,1)*x1 + A(3,2)*x2 - b(3), [-5 10 0 3], 'g', 'LineWidth', 1.5);
    fimplicit(@(x1, x2) A(4,1)*x1 + A(4,2)*x2 - b(4), [-5 10 0 3], 'm', 'LineWidth', 1.5);
