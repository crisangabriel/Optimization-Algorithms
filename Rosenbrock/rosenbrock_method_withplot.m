function [x_opt, f_opt] = rosenbrock_method_withplot(f, x0, d, s, alpha, beta, epsilon, max_iterations)
...
while ~stop_criterion && k <= max_iterations
    ...
    if oscillation
        ...
        %This results in a vector of length n
...
plot(x_opt(1), x_opt(2), 'go', 'MarkerSize', 8, 'DisplayName', 'Optimal Point');
legend;
hold off;
end
